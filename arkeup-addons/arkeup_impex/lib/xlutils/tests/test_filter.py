...
from odoo.addons.arkeup_impex.lib.xlutils.filter import BaseReader,GlobReader,MethodFilter,BaseWriter,process,XLRDReader,XLWTWriter, BaseFilter
from odoo.addons.arkeup_impex.lib.xlutils.tests.fixtures import test_files,test_xls_path,make_book,make_sheet,DummyBook
...
class TestBaseFilter(TestCase):
    ...
    def setUp(self):
        from odoo.addons.arkeup_impex.lib.xlutils.filter import BaseFilter
...
from odoo.addons.arkeup_impex.lib.xlutils.filter import Echo
...
class TestMemoryLogger(TestCase):
    ...
    def setUp(self):
        from odoo.addons.arkeup_impex.lib.xlutils.filter import MemoryLogger
...
from odoo.addons.arkeup_impex.lib.xlutils.filter import ErrorFilter
...
from odoo.addons.arkeup_impex.lib.xlutils.filter import ColumnTrimmer
...
class TestDirectoryWriter(TestCase):
    ...
    def test_inheritance(self):
        from odoo.addons.arkeup_impex.lib.xlutils.filter import DirectoryWriter
