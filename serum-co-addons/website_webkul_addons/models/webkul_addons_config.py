...
class WebkulWebsiteAddons(models.TransientModel):
    ...
    module_odoo_stock_per_warehouse = fields.Boolean(string="Website : Stock Available Info")
    ...
    module_ecommerce_advance_search = fields.Boolean(string="Website: Ecommerce Advance Search")
    ...
    module_website_order_cancel = fields.Boolean(string="Website: Order Cancel")
    module_website_giftwrap = fields.Boolean(string="Website: Gift Wrap")
    module_website_promotion_bar = fields.Boolean(string="Website: Promotion Bar")
    module_website_guest_checkout = fields.Boolean(string='Webiste: Guest Checkout')