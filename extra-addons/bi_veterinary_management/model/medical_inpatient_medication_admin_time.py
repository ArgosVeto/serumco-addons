...
class medical_inpatient_medication_admin_time(models.Model):
    ...
    health_professional_id = fields.Many2one('medical.physician',string='Health Professional')
    dose_unit = fields.Many2one('medical.dose.unit',string='Dose Unt')
    medical_inpatient_medicament_id = fields.Many2one('medical.inpatient.medication',string='Admin Time')   
