...
class medical_surgery(models.Model):
    ...
    state = fields.Selection([
        ...
        ('done', 'Done'),
        ], string='Status', readonly=True, copy=False, index=True, track_visibility='onchange', default='in_progress')
    ...
    hospital_operating_room_id = fields.Many2one('medical.hospital.oprating.room','Operating Room')
    ...
    medical_operation_ids = fields.One2many('medical.operation','medical_surgery_id')
    extra_info = fields.Text(string="Details/Incidents")
