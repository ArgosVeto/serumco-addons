...
from . import medical_disease_gene
from . import medical_domiciliary_unit
...
from . import medical_paper_archive
...
from . import medical_patient_prental_evoultion
...
from . import medical_vaccination
