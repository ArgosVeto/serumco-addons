...
class medical_newborn(models.Model):
    ...
    discharge_date  = fields.Datetime('Discharged')
    weight = fields.Integer('Weight')
    physician_id = fields.Many2one('medical.physician','Doctor in charge')
    ...
    cause_of_death_id = fields.Many2one('medical.pathology','Cause Of Death')
    congenital_disease_ids = fields.One2many('medical.patient.diseases', 'new_born_id')
