...
class medical_patient_rounding(models.Model):
    ...
    medical_health_physician_id = fields.Many2one('medical.physician',string="Health Professional",readonly=True)
    ...
    gcs_id = fields.Many2one("medical.icu.glasgow",string="GCS")
    ...
    left_pupil = fields.Integer(string="left pupil")
    ...
    chest_drainages_ids = fields.One2many('medical.icu.chest_drainage','medical_patient_rounding_chest_drainage_id',string="Chest Drainages")
    ecg_id = fields.Many2one('medical.icu.ecg',string="ECG")
    ...
    location_id = fields.Many2one('stock.location',string='Hospitalization Location')
