...
class medical_imaging_test_request_wizard(models.TransientModel):
    ...
    physician_id = fields.Many2one('medical.physician',string="Name Of Physician", required = True)
    ...
    def create_lab_imaging_request(self):
        ...
        for wizard_obj in self:
            ...
            if new_created_id_list:
                ...
                action = imd.xmlid_to_object('bi_veterinary_management.bi_action_medical_imaging_test_result_draft')
                list_view_id = imd.xmlid_to_res_id('bi_veterinary_management.medical_imaging_test_request_tree')
                form_view_id  =  imd.xmlid_to_res_id('bi_veterinary_management.bi_medical_imaging_test_request_form_view')
