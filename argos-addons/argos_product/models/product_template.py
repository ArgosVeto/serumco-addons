...
class ProductTemplate(models.Model):
    ...
    aliment_type = fields.Html('Aliment Type')
    utilization = fields.Html('Utilization')
    composition = fields.Html('Composition')
    analytic_constitution = fields.Html('Analytic Constitution')
    additives = fields.Html('Additives')
    energetic_value = fields.Html('Energetic Value')
    daily_ratio_recommended = fields.Html('Daily Ratio Recommended')
    indications = fields.Html('Indications')
    waters_content = fields.Html('Waters Content')
