...
class CalendarAppointmentType(models.Model):
    ...
    species_id = fields.Many2one('res.partner.category', string='Species', domain=[('type', '=', 'patient')])
    ...
    def _slots_available(self, slots, first_day, last_day, employee=None):
        ...
        def is_calendar_available(slot, events, employee):
            ...
            for ev in events.filtered(lambda ev: ev.start < end_dt_string and ev.appointment_stop > start_dt_string):
                if ev.allday:
