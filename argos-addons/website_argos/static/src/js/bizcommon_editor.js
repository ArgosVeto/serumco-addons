odoo.define('website_argos.bizcommon_editor_js', function(require) {
    'use strict';
    ...
    ajax.loadXML('/website_argos/static/src/xml/website_argos.xml', qweb);
    ...
    options.registry.oe_cat_slider = options.Class.extend({
        ...
        cat_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("website_argos.bizcommon_dynamic_category_slider"));
                ...
                ajax.jsonRpc('/website_argos/category_get_options', 'call', {}).then(function(res) {
    ...
    options.registry.website_argos_product_slider = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
        ...
        prod_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                ...
                self.$modal = $(qweb.render("website_argos.bizcommon_dynamic_product_slider"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                var $slider_filter = self.$modal.find("#slider_filter"),
                ...
                ajax.jsonRpc('/website_argos/product_get_options', 'call', {}).then(function(res) {
                    $('#slider_filter option[value!="0"]').remove();
                    _.each(res, function(y) {
                        $("select[id='slider_filter'").append($('<option>', {
                            value: y["id"],
    ...
    options.registry.s_bizople_theme_multi_product_tab_snippet = options.Class.extend({
        ...
        multi_category_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("website_argos.multi_product_custom_slider_block"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                var $slider_filter = self.$modal.find("#slider_filter"),
                ...
                ajax.jsonRpc('/website_argos/product_multi_get_options', 'call', {}).then(function(res) {
    ...
    options.registry.prod_brands = options.Class.extend({
        ...
        bizcommon_brand_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("website_argos.brands_slider_block"));
                self.$modal.appendTo('body');
                self.$modal.modal();
    ...
    options.registry.health_blog_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".health_blog_slider").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
            this._super();
            if (this.website_argos_blog_slider()) {
                this.website_argos_blog_slider().fail(function() {
                    self.getParent()._removeSnippet();
                });
            }
        },
        ...
        website_argos_blog_slider: function(type, value) {
            var self = this;
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("website_argos.bizcommon_blog_slider_block"));
                self.$modal.appendTo('body');
                self.$modal.modal();
                ...
                ajax.jsonRpc('/website_argos/blog_get_options', 'call', {}).then(function(res) {
    ...
    options.registry.website_argos_blog_custom_snippet = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
            ...
            if (!editMode) {
                self.$el.find(".bizcommon_blog_slider").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.s_bizople_theme_blog_slider_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_slider_owl").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_3_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_3_custom").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_4_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_4_custom").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_6_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_6_custom").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_5_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_5_custom").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_8_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_8_custom").on("click", _.bind(self.website_argos_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
