...
class SaleOrder(models.Model):
    ...
    category_id = fields.Many2one('animal.category', related='animal_id.category_id')
    sex = fields.Selection(related='animal_id.sex', string='Sex')
    age = fields.Float('Age', related='animal_id.age')
    weight = fields.Float('Weight', related='animal_id.weight')
    pathology_ids = fields.Many2many('animal.pathology')
